...
- [2026-06-24](claude-2026-06-24.md) — Added 5 new macro signals (IG OAS, Copper/Gold, NFCI, DXY, ISM PMI) and concurrency limiter to prevent socket exhaustion on cold cache; do NOT delete macro cache files casually | build | next: Apply DB migration 0001 (run drizzle-kit migrate from Replit shell with env vars). Verify macro tab loads cleanly. Then file-split: options-scanner.tsx(1199L), stock-breakdown.tsx(1084L), portfolio.tsx(955L)
