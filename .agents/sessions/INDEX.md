...
- [2026-06-24](claude-2026-06-24.md) — Workflow hooks added: Read guard (warns on files >150L without offset+limit), Playwright status in rehydrate, codegraph_node default:false in memory | build | next: Apply same file-split treatment to other large files: options-scanner.tsx(1199L), stock-breakdown.tsx(1084L), portfolio.tsx(955L)
