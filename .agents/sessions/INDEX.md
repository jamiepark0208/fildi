...
- [2026-06-18](claude-2026-06-18.md) — added file-reading-strategy.md skill; audited never-read file list; discussed context optimization | build | next: Reset user password;verify profile page in browser;Phase 5 FILDI approval;verify chart EMA lines and zone labels
