...
- [2026-06-24](claude-2026-06-24.md) — Macro tab fully reorganized into themed sub-tabs with COT embedded, TradingView widgets for heatmap and calendar | build | next: New Macro tab data additions: put/call ratios (CBOE), GSCPI (NY Fed), money market fund AUM/liquidity indicators
