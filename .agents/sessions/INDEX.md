...
- [2026-06-24](claude-2026-06-24.md) — Fixed broken Macro tab data sources, AI highlights token truncation, and 14 TS errors; added 2 TradingView widgets | build | next: Rebuild api-server. Then apply file-split treatment to large files: options-scanner.tsx(1199L), stock-breakdown.tsx(1084L), portfolio.tsx(955L)
