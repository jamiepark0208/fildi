...
- [2026-06-21](claude-2026-06-21.md) — Portfolio Analysis now uses CSV market values; option direction/expiry fixes; macro tab new charts; options scanner BEST row highlighted amber | build | next: reset user password; verify profile page in browser; Phase 5 FILDI approval; verify chart EMA lines and zone labels
