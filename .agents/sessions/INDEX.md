...
- [2026-06-26](claude-2026-06-26.md) — auto-saved | build | next: 1) Enhance Stock DB tab: add Fundamental group label, Technical columns, per-ticker status icon (queued/in-progress/done)
