...
- [2026-06-19](claude-2026-06-19.md) — auto-saved | build | next: Reset user password;verify profile page in browser;Phase 5 FILDI approval;verify chart EMA lines and zone labels
