...
- [2026-06-18](claude-2026-06-18.md) — session-wrap now stages all source, skill, and doc changes automatically | build | next: Reset user password;verify profile page in browser;Phase 5 FILDI approval;verify chart EMA lines and zone labels
