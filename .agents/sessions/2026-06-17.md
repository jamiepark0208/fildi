...
## 2026-06-17 02:10 — Merged scorecard guide and chart zones PR; main up to date.
- Phase: build
...
- Next: Smoke-test Watchlist chart zones + Scorecard Guide admin weights on main; FILDI feed Phase 5 or restore login pw per state.md
